...
In practice, browsers largely have the same features and agree on how to implement them, enough so that you don't really need to worry about cross-browser differences for the purposes of this cookbook. But it's good to be aware of the issue, and it's a useful reminder here that we're looking at extensions that different runtime environments built by different people make to standard JavaScript syntax. 
...
<img width="904" alt="Three boxes visualizing selected things available in core JavaScript like functions and arrays, things available in web browsers like the DOM and Window interface, and things available in Node like the HTTP module and Process module." src="https://github.com/user-attachments/assets/861d45e6-9c80-47d7-9904-84d24e033ab1">
